...
const playStoreUrl =
  'https://play.google.com/store/apps/details?id=com.firstballapp';
...
const errorMessage = {
  ...
  PREVIOUS_DATE_OF_BIRTH_IS_LATER_THAN_FIRST_DAY_OF_CYCLE:
    'PREVIOUS_DATE_OF_BIRTH_IS_LATER_THAN_FIRST_DAY_OF_CYCLE',
  NO_PRODUCT_FOUND_BY_NAME: 'NO_PRODUCT_FOUND_BY_NAME',
  REVEAL_ALREADY_HAS_FEEDBACK: 'REVEAL_ALREADY_HAS_FEEDBACK',
  PREVIOUS_DATE_OF_BIRTH_IS_LATER_THAN_DUE_DATE:
    'PREVIOUS_DATE_OF_BIRTH_IS_LATER_THAN_DUE_DATE',
  MISSING_CLIENT_SECRET_IN_PAYMENT_INTENT:
    'MISSING_CLIENT_SECRET_IN_PAYMENT_INTENT',
};
